...
namespace Tutorial.Bot
{
    public class DialogAndWelcomeBot<T> : DialogBot<T> where T : Dialog
    {
        ...
        private const string WelcomeMessage = @" bem vindo! Em que posso ser útil?";
            ...
            CancellationToken cancellationToken)
        {
            foreach (var member in membersAdded)
            {
                ...
                //    await turnContext.SendActivityAsync($"Olá - {member.Name}", cancellationToken: cancellationToken);
